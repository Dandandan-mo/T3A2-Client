  ...
  return (
    ...
    <MediaQuery maxWidth={1200}>
        ...
        <div style={{margin:"2rem"}}>
          <h2 className="product-detail-name" style={{fontSize: "2rem", fontFamily: "'Patrick Hand', cursive"}}>{product.name}</h2>
          <h3 className="product-detail-price" style={{fontSize:"1.5rem", fontFamily: "'Patrick Hand', cursive"}}>Price: $ {product.price}</h3>
          <p className="detail-description" style={{fontSize:"1rem"}}>{product.description}</p>
          <button id="add-product"onClick={addProduct} type="button" className="btn btn-info" style={{fontSize:"1.5rem", fontFamily: "'Patrick Hand', cursive"}}>Add to Cart</button>
        </div>
    </MediaQuery>
